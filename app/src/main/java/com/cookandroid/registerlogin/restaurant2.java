...
public class restaurant2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        task.execute("http://thee153.dothome.co.kr/MenuList2.php");
        ...
        btn_buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (menu.equals(""))
                    ...
                    RequestQueue queue = Volley.newRequestQueue(restaurant2.this);
                    queue.add(menuRequest);

                    Count2Request countRequest = new Count2Request(menu,time, responseListener);
                    RequestQueue queue1 = Volley.newRequestQueue(restaurant2.this);
    ...
    private class GetData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(restaurant2.this,
    ...
    private void showResult(){
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    restaurant2.this, mArrayList, R.layout.item_list2,
                    new String[]{TAG_ID,TAG_NAME, TAG_ADDRESS},
                    new int[]{R.id.textView_list_id, R.id.textView_list_name, R.id.textView_list_address}
            );
            restaurant2.ClickListener listener = new restaurant2.ClickListener();
