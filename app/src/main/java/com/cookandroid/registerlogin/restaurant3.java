...
public class restaurant3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        task.execute("http://thee153.dothome.co.kr/MenuList3.php");
        ...
        btn_buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (menu.equals(""))
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (success) {
                                    ...
                                    Intent intent1 = new Intent(restaurant3.this, MainActivity.class);
                    ...
                    RequestQueue queue = Volley.newRequestQueue(restaurant3.this);
                    queue.add(menuRequest);

                    Count3Request countRequest = new Count3Request(menu,time, responseListener);
                    RequestQueue queue1 = Volley.newRequestQueue(restaurant3.this);
...
//                startActivity(intent1);
    ...
    private class GetData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(restaurant3.this,
    ...
    private void showResult(){
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    restaurant3.this, mArrayList, R.layout.item_list3,
                    new String[]{TAG_ID,TAG_NAME, TAG_ADDRESS},
                    new int[]{R.id.textView_list_id, R.id.textView_list_name, R.id.textView_list_address}
            );
            restaurant3.ClickListener listener = new restaurant3.ClickListener();
