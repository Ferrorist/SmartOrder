...
public class restaurant4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        task.execute("http://thee153.dothome.co.kr/MenuList4.php");
        ...
        btn_buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (menu.equals(""))
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (success) {
                                    ...
                                    Intent intent1 = new Intent(restaurant4.this, MainActivity.class);
                    ...
                    RequestQueue queue = Volley.newRequestQueue(restaurant4.this);
                    queue.add(menuRequest);

                    Count4Request countRequest = new Count4Request(menu,time, responseListener);
                    RequestQueue queue1 = Volley.newRequestQueue(restaurant4.this);
...
//                startActivity(intent1);
    ...
    private class GetData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(restaurant4.this,
    ...
    private void showResult(){
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    restaurant4.this, mArrayList, R.layout.item_list4,
                    new String[]{TAG_ID,TAG_NAME, TAG_ADDRESS},
                    new int[]{R.id.textView_list_id, R.id.textView_list_name, R.id.textView_list_address}
            );
            restaurant4.ClickListener listener = new restaurant4.ClickListener();
