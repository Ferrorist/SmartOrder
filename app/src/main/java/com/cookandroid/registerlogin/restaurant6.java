...
public class restaurant6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        task.execute("http://thee153.dothome.co.kr/MenuList6.php");
        ...
        btn_buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (menu.equals(""))
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (success) {
                                    ...
                                    Intent intent1 = new Intent(restaurant6.this, MainActivity.class);
                    ...
                    RequestQueue queue = Volley.newRequestQueue(restaurant6.this);
                    queue.add(menuRequest);

                    Count6Request countRequest = new Count6Request(menu,time, responseListener);
                    RequestQueue queue1 = Volley.newRequestQueue(restaurant6.this);
    ...
    private class GetData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(restaurant6.this,
    ...
    private void showResult(){
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    restaurant6.this, mArrayList, R.layout.item_list6,
                    new String[]{TAG_ID,TAG_NAME, TAG_ADDRESS},
                    new int[]{R.id.textView_list_id, R.id.textView_list_name, R.id.textView_list_address}
            );
            restaurant6.ClickListener listener = new restaurant6.ClickListener();
